...
const BASE_CV_SECTIONS = {
  ...
  vistra_bullets: [
    ...
    "Defined product vision, strategy and roadmaps; secured \u00a3400k+ business case sign-off aligned to market opportunities and commercial viability",
    "Managed 4 Business Analysts (reporting, data migration, SOPs, tech implementation); coordinated cross-functional delivery across engineering, compliance and front office",
    "Produced SteerCo-ready updates on progress, risks and dependencies; aligned CFO/COO and senior leadership on scope decisions, delivery milestones and go-to-market activities",
  ],
  ebury_bullets: [
