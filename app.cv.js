...
const BASE_CV_SECTIONS = {
  ...
  key_achievements: [
    ...
    "Designed Napier screening framework reviewed during Dutch DNB effectiveness assessment",
  ...
  vistra_bullets: [
    "Owned end-to-end workflow and data design for onboarding operations across Enate and Fenergo, defining flows, screens, data fields, task structures and hand-offs to support corporate and fund client journeys across multiple jurisdictions",
    "Designed onboarding, periodic reviews and maintenance journeys in Fenergo, including task decomposition, evidence requirements and decision points aligned to regional operating models",
    "Created and maintained global process design roadmap; produced standard and target process maps for onboarding, screening and periodic review operations",
    "Built the implementation backlog and delivery plan from process discovery, translating operational needs into configurable requirements for vendors and engineering, ensuring reuse across jurisdictions",
    "Led configuration of screening thresholds and tuning for sanctions, PEP and adverse media, working with regional teams to test outcomes across jurisdictions and reduce noise while maintaining risk coverage",
    "Partnered with operations and compliance SMEs to validate alert performance and agree threshold governance, balancing service levels, customer impact and regulatory expectations",
    "Ran structured UAT and rollout across jurisdictions, coordinating testers, test scripts, defect triage and release readiness for onboarding and screening changes",
    "Conducted regulatory scanning and change assessment across FCA, Dutch DNB, BaFin, MAS and SFC; translated requirements into platform configuration and control specifications",
    "Built \u00a3400k+ business case including cost-benefit analysis, vendor evaluation and pricing negotiation; produced business change proposals for Regional Operations Directors",
    "Managed 2 Business Analysts (screening and CLM integration); coordinated cross-functional delivery across engineering, compliance and front office",
    "Produced SteerCo-ready updates on progress, risks and dependencies; presented to CFO/COO and senior leadership on scope decisions, delivery milestones and operational readiness",
  ],
  ebury_bullets: [
