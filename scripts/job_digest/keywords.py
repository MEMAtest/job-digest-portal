...
EXCLUDE_COMPANIES = {
    ...
    "transferwise",
    "transferwise ltd",
    # --- consulting / advisory firms (Ade wants in-house product, not consulting) ---
    "capco",
    "deloitte",
    "pwc",
    "kpmg",
...
TIER1_CORE_BOARD_KEYWORDS = [
    # --- in-house product titles for Ade's lane (added) ---
    ...
    "payment screening product manager",
    "sanctions screening product manager",
    "1lod controls product manager",
    "merchant onboarding product manager",
    "partner onboarding product manager",
    "remittance compliance product manager",
    "customer risk product manager",
    "kyc systems product owner",
